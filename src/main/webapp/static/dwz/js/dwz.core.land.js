	...
	$.fn.extend({
		...
		layoutH: function($refBox){
			return this.each(function(){
				...
				//console.log("iLayoutH:"+iLayoutH);
				//console.log("iH:"+iH);

				//表格自适应高度（容器高度-查询表单高度-表格标题高度-分页条高度）
				//var $pageHeaderHeight=$refBox.find(".pageHeader").outerHeight(true);
				//console.log("$pageHeaderHeight:"+$pageHeaderHeight);
				//var $pageBarHeight=$refBox.find(".pageBar").outerHeight(true);
				//console.log("$pageBarHeight:"+$pageBarHeight);
				//var $gridHeaderHeight=$refBox.find(".gridHeader").outerHeight(true);
				//console.log("$gridHeaderHeight:"+$gridHeaderHeight);
				//var iH=iRefH-$pageHeaderHeight-$pageBarHeight-$gridHeaderHeight;
				//console.log("iRefH:"+iRefH);
				//console.log("iH:"+iH);
